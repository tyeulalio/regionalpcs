...
The goal of regionalpcs is to provide functions to easily summarize DNA methylation data on a regional level using regional principal components (rPCs). The rPCs help to capture more biologically-relevant signal for downstream analyses.
